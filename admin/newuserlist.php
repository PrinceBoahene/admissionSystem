                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-3">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php $serialSstat = 1; $course = $con->query("SELECT * FROM candidatedetails where serialStatus ='$serialSstat' order by id asc");  echo $course->num_rows; ?></div>
                                        </div>
					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
                                // $admStat = 1;  WHERE admStatus ='$admStat'
								$course = $con->query("SELECT * FROM adm  order by id asc");
								...
								<tr>
                                    ...
                                    <td>
                                    <p><small><b><?php echo $row['contact'] ?></b></small></p>

                                    </td>
                                    <td>
                                    <p><small><b><?php if($row['admStatus'] == 0){echo "Inactive";}else{echo "Active";} ?></b></small></p>

                                    </td>
									<td class="text-center">
										<button class="btn btn-sm btn-success edit_course" type="button" data-id="<?php echo $row['id'] ?>" data-course="<?php echo $row['username'] ?>" data-description="<?php echo $row['contact'] ?>" >View</button>
										<button class="btn btn-sm btn-primary edit_course" type="button" data-id="<?php echo $row['id'] ?>" data-course="<?php echo $row['username'] ?>" data-description="<?php echo $row['contact'] ?>" >Edit</button>
										<button class="btn btn-sm btn-info edit_course" type="button" data-id="<?php echo $row['id'] ?>" data-course="<?php echo $row['username'] ?>" data-description="<?php echo $row['contact'] ?>" >Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
