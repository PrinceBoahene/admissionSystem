...
if($pass != $cpass){
  ...
  $query = "SELECT * FROM adm WHERE contact != '$_POST[contact]'";
...
$admSta = 1;
// date of application
    $insertQuery =  "INSERT INTO `adm` (`username`, `contact`, `password`,`admStatus`) VALUES
                        ('$name','$contact','$pass', '$admSta')";
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item ">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseUtilitis" aria-expanded="true" aria-controls="collapseUtilities">
                    <i class="fas fa-users"></i>
                    <span>Candidates</span>
                </a>
                <div id="collapseUtilitis" class="collapse " aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Inactive Users
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                    ...
                                    <form action="newuser.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="form-outline">
                                                    <label class="form-label" for="form8Example4">Contact <small style="color: red;"> *</small></label>
                                                    <input type="text" name="contact" id="form8Example4" class="form-control" value="" required />
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <!-- Name input -->
                                                <div class="form-outline">
                                                    <label class="form-label" for="form8Example3">Password <small style="color: red;">*</small></label>
