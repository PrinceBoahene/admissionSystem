                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Number Serial Codes generated</div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Inactive Serial Code
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card mb-8">
                                <div class="card-header">
                                    Generate Serial code and PIN
                                </div>
                                <div class="card-body">
                                <form action="serialNumberGenerate.php" method="POST"  class="uk-form uk-form-horizontal ">
                                <fieldset data-uk-margin>
                                <legend class="uk-text-danger">Enter Applicant details to proceed</legend>
