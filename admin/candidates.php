					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								$i = 1;
                                $admStat = 1;
								$course = $con->query("SELECT * FROM candidatedetails WHERE admStatus ='$admStat' order by id asc");
								...
								<tr>
                                    ...
                                    <td>
                                    <p><small><b><?php echo "0".$row['candidateID'] ?></b></small></p>

                                    </td>
									<td class="text-center">
										<button class="btn btn-sm btn-success edit_course" type="button" data-id="<?php echo $row['id'] ?>" data-course="<?php echo $row['Firstname'] ?>" data-description="<?php echo $row['Phone'] ?>" >View</button>
										<button class="btn btn-sm btn-primary edit_course" type="button" data-id="<?php echo $row['id'] ?>" data-course="<?php echo $row['Firstname'] ?>" data-description="<?php echo $row['Phone'] ?>" >Edit</button>
										<button class="btn btn-sm btn-primary edit_course" type="button" data-id="<?php echo $row['id'] ?>" data-course="<?php echo $row['Firstname'] ?>" data-description="<?php echo $row['Phone'] ?>" >Delete</button>
