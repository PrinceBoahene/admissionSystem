                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="Search for student ..."
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Estimated Applicant
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    The number of application this week is more than last week. We still need more
                                    applications. The SRC has to go and broadcast the university information.
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    Auto generate student number immediately, the administrator approve.
                                    Auto generate student number immediately, the administrator approve.
                                    Auto generate student number immediately, the administrator approve.
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Estimated Applicants</h6>
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    Due to the estimated applicant the school needs, administrator can <b>pause, close and boost</b>
                                    the Admission process. most likely when the estimated rate reaches 100%, automatically the process 
                                    will be pause. The administrator has to boost it again if they still need more applicants.
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="collapse show" id="collapseCardExample">
                                    <div class="card-body">
                                       Most applicants do not want to pay for the serial code because it is easy to generate. All 
                                       applicants has the freedom to generate the serial number but has to pay to validate the serial 
                                       number and the PIN. The code also expires after 24 hours if not used.
                                    </div>
                                </div>
                            </div>
